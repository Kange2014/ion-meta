...
![alt text or image title](figures/ion-meta-v2.UG-1.png)
...
4.  在列出的样本表格中勾选想要分析的样本；输入分析名称，点击启动分析； ![alt text or image title](figures/ion-meta.UG-9.png)
...
![alt text or image title](figures/ion-meta-v2.UG-2.png)
...
![alt text or image title](figures/ion-meta-v2.UG-3.png)
...
![alt text or image title](figures/ion-meta-v2.UG-4.png)
...
![alt text or image title](figures/ion-meta-v2.UG-5.png)
...
![alt text or image title](figures/ion-meta-v2.UG-6.png)
...
注：标题栏后第一行物种名都是root，表示样本中的有一些测序数据不能比对到数据库中的任何物种基因组序列；第三列的物种分类地位如果是leaf，表示该物种的分类单元为最下层。
...
![alt text or image title](figures/ion-meta-v2.UG-7.png)

### 病毒拼接结果下载

对于本报告第二部分所列出的病毒类目标物种，如果比对上的reads能够拼接，则提供拼接基因组草图结果下载。

![alt text or image title](figures/ion-meta-v2.UG-8.png)
